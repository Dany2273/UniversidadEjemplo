...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem10.setText("Administracion de Materias");
    ...
    private void jMenuItem10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem10ActionPerformed
        ...
        Escritorio.removeAll();
        Escritorio.repaint();
        mtodo mtodo = new mtodo();
        mtodo.setVisible(true);
        Escritorio.add(mtodo);
        Escritorio.moveToFront(mtodo);
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        // TODO add your handling code here:
         int resp = JOptionPane.showConfirmDialog(null, "¿Desea salir del programa?", "Atención!",
